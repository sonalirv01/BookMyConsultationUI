...
const DoctorTile = (props) => {
    ...
    // Error handling: if doctorData is missing or incomplete, show an error message.
    if (!doctorData || !id) {
        return (
            <Grid item className={classes.root}>
                <Paper className={classes.paper}>
                    <Typography gutterBottom variant="body1" component="p" className={classes.errorText}>
                        Error: Doctor information is unavailable.
                    </Typography>
                </Paper>
            </Grid>
        );
            ...
            <Paper className={classes.paper}>
                ...
                <div className={classes.btnContainer}>
                    ...
                    <Button
                        ...
                        color="secondary"
                        size="small"
                        onClick={() => showPopup("DoctorDetails", doctorData)}
                    >
                        View Details
                    </Button>
                </div>
